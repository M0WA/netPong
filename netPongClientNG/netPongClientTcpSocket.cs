...
namespace netPongClientNG
{
    class netPongClientTcpSocket
    {
        ...
        public netPongClientTcpSocket(string strUsername, string strServerIP, int nServerPort)
        {
            ...
            try
            {
                ...
                netPongClientGlobals.hMessageForm.strLogString += ("Connecting to server (" + srvEndPoint.ToString() + ")...");

                m_hServerSock.BeginConnect(srvEndPoint, new AsyncCallback(ConnectCallBack), m_hServerSock);
            }
            catch (Exception e)
            {
                netPongClientGlobals.hMessageForm.strLogString += ("Error\r\n");
                netPongClientGlobals.hMessageForm.strLogString += (e.ToString() + "\r\n");
            }
        }
        ...
        public static void ConnectCallBack(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                netPongClientGlobals.hMessageForm.strLogString += ("OK\r\n");
                SendHelloCommand();
            }
            catch (Exception e)
            {
                netPongClientGlobals.hMessageForm.strLogString += ("Error\r\n");
                netPongClientGlobals.hMessageForm.strLogString += (e.ToString() + "\r\n");
                netPongClientGlobals.hLoginForm.bLoggedIn = false;
            }
        }
        ...
        public static void SendHelloCommand()
        {
            ...
            try
            {
                netPongClientGlobals.hMessageForm.strLogString += ("Logging in using username " + m_strUsername + "...");
        ...
        public static void CloseConnectionCallback(IAsyncResult ar)
        {
            try
            {
                ...
                m_hServerSock.Close();
                netPongClientGlobals.hMessageForm.strLogString += ("Connection closed\r\n");
            }
            catch (Exception e)
            {
                m_hServerSock.Shutdown(SocketShutdown.Both);
        ...
        public static void SendInvitePlayerCommand(string strPlayerName)
        {
            ...
            try
            {
                ...
                netPongClientGlobals.hMessageForm.strLogString += ("Sending invitation to " + strPlayerName + "\r\n");
            }
            catch (Exception e)
            {
                netPongClientGlobals.hMessageForm.strLogString += ("Error\r\n");
        ...
        public static void ParseRejectInvite(byte[] nPacket)
        {
            ...
            {
                netPongClientGlobals.hMessageForm.strLogString += ("No valid username found\r\n");
                return;
            }
            ...
            for (int i = 0; i < openInvitations.Count; i++)
            {
                ...
                {
                    netPongClientGlobals.hMessageForm.strLogString += ("Your invitation has been rejected from " + strPlayer + "\r\n");
        ...
        public static void ParsePlayerInvite(byte[] nPacket)
        {
            ...
            for (int i = 0; i < openInvitations.Count; i++)
            {
                ...
                if (strPlayerName.Equals(strPlayer))
                {
                    netPongClientGlobals.hMessageForm.strLogString += ("Recieved invitation confirmation from " + strPlayerName + "\r\n");
                    netPongClientGlobals.hGameForm.StartGame();
                    return;
                }
            }
            netPongClientGlobals.hMessageForm.strLogString += ("Recieved invitation from " + strPlayerName + "\r\n");
            netPongClientGlobals.hGameForm.strInvitationName = strPlayerName;
        }
        ...
        private static void ParseTextMessageCommand(byte[] nPacket)
        {
            ...
            netPongClientGlobals.hChatForm.AddChatMessage = msgChatArray;
            //TODO
            //netPongGlobals.hChatForm.Show();

            netPongClientGlobals.hMessageForm.strLogString += "Incoming message from " + strSender + "\r\n";
        }
        ...
        public static void SendRejectInviteCommand(string strPlayerName)
        {
            ...
            try
            {
                ...
                netPongClientGlobals.hMessageForm.strLogString += ("Rejecting invitation from " + strPlayerName + "\r\n");
            }
            catch (Exception e)
            {
                netPongClientGlobals.hMessageForm.strLogString += ("Error\r\n");
        ...
        public static void ReadCallback(IAsyncResult ar)
        {
            ...
            switch ((int)nOpCode)
            {
                case ((int)netPongTcpOpCodes.NP_TCP_CMD_WELCOME):
                    netPongClientGlobals.hMessageForm.strLogString += ("Logged In\r\n");
                    netPongClientGlobals.hLoginForm.bLoggedIn = true;
                    SendListPlayersCommand();
                    break;

                case ((int)netPongTcpOpCodes.NP_TCP_CMD_PLAYERSLIST):
                    netPongClientGlobals.hMessageForm.strLogString += ("Recieved players list\r\n");
                    ArrayList players = ParsePlayersList(nPacket);
                    netPongClientGlobals.hMessageForm.strLogString += ("Players online " + players.Count + ":\r\n");
                    netPongClientGlobals.hLoginForm.playerOnline = players;
                    netPongClientGlobals.hChatForm.playersArray = players;
                    break;
                ...
                default:
                    netPongClientGlobals.hLoginForm.bLoggedIn = false;
                    netPongClientGlobals.hMessageForm.strLogString += ("Invalid command recieved, closing connection\r\n");
        ...
        private static void ParseStartGame(byte[] bytePacket, IPAddress serverIP)
        {
            ...
            netPongClientGlobals.hUDPGameSession = new netPongClientUdpGameSession(nSessionID, nPlayerID, serverEP);
            
            netPongClientGlobals.hMessageForm.strLogString += ("Establishing UDP game session (ID: " + nSessionID + " / Player ID: " + nPlayerID + ")\r\n");
            netPongClientGlobals.hMessageForm.strLogString += ("UDP game session is at " + serverEP.Address.ToString() + ":" + serverEP.Port + "\r\n");
        }
    }
}
